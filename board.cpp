...
board_t::board_t()
{
    ...
    auto vertex_shader{
        utilities::create_shader(vertex_source, GL_VERTEX_SHADER)};
    auto fragment_shader{
        utilities::create_shader(fragment_source, GL_FRAGMENT_SHADER)};
    ...
    std::array<float, 4 * 4> vertices{// Positions    // UVs
    ...
    std::array<uint8_t, 6> indices{0, 1, 2, 0, 3, 2};
...
void board_t::set_flipped(bool p_is_flipped) noexcept
{
    ...
    glUniform1i(uniform_location, static_cast<int>(p_is_flipped));
}
