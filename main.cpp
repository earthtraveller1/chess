...
int main()
{
    ...
    std::cout << "[INFO]: The program is now running in " << program_location
              << std::endl;
...
#ifdef _WIN32
int WINAPI wWinMain(HINSTANCE p_instance, HINSTANCE,
                    LPWSTR p_command_line_arguments, int p_show_command)
{
