...
menu_scene_t::menu_scene_t(scene_manager_t &p_scene_manager,
    ...
    : m_scene_manager(p_scene_manager),
      ...
      m_window_width(p_window_width), m_window_height(p_window_height)
{
...
void menu_scene_t::render()
{
    ...
    if (m_button_manager.is_button_hovered(play_button_x, play_button_y, 3.0,
                                           1.5))
    {
...
void menu_scene_t::on_mouse_click(int p_button, int p_action)
{
    ...
    if (m_button_manager.is_button_hovered(play_button_x, play_button_y, 3.0,
                                           1.5) &&
        p_button == GLFW_MOUSE_BUTTON_LEFT && p_action == GLFW_PRESS)
    {
...
{
    m_button_manager.update_mouse_positions((p_xpos / m_window_width) * 8.0,
                                            (p_ypos / m_window_height) * 8.0);
}