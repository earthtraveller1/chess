...
application_t::context_debugger::context_debugger()
{
    ...
    glDebugMessageCallback(
        [](GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar *p_message,
           const void *)
        {
...
application_t::application_t()
    : m_window(window_t::get_instance()),
      m_scene_manager(std::make_shared<menu_scene_t>(
          m_scene_manager, m_window.get_width(), m_window.get_height()))
{
...
bool application_t::is_open() const { return m_window.is_open(); }
